  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-8 md:py-12">
        <h1 className="text-3xl md:text-4xl font-bold mb-6 md:mb-8">Most Popular</h1>
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-3 md:gap-4">
            {trending?.mostPopularAnimes?.map((anime: any, index: number) => (
              <Link key={`popular-${anime.id}-${index}`} href={`/anime/${anime.id}`}>
                <Card
                  ...
                  data-testid={`card-popular-${anime.id}`}
                >
